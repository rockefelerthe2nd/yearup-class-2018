...
//fourth scroll effect
$(document).ready(function(){
  $(window).scroll(function(){

    if($(this).scrollTop()>2200){
      $(".section_four").css({"opacity" : "0.5"})
      $(".nav_bar").css({"background-color" : "#d38ba7"})
    }
    else{
      $(".section_four").css({"opacity" : "1"})
    }
  })
})
...
// var y = 0;
// function myFunction() {
//     var elmnt = document.querySelectorAll("body");
//     y = elmnt.scrollTop;
//     document.querySelectorAll("body").innerHTML = "Vertically: " + y + "px";
// }
